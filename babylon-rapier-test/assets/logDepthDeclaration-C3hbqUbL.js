import{k as e}from"./babylon-YuYqH10H.js";const t="sceneUboDeclaration",l=`layout(std140,column_major) uniform;uniform Scene {mat4 viewProjection;
#ifdef MULTIVIEW
mat4 viewProjectionR;
#endif 
mat4 view;mat4 projection;vec4 vEyePosition;mat4 inverseProjection;};
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=l);const p={name:t,shader:l},a="meshUboDeclaration",f=`#ifdef WEBGL2
...
#endif
#endif 
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=d);const N={name:r,shader:d},i="harmonicsFunctions",m=`#ifdef USESPHERICALFROMREFLECTIONMAP
...
#endif
#endif
`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=m);const S={name:i,shader:m},c="logDepthDeclaration",h=`#ifdef LOGARITHMICDEPTH
uniform float logarithmicDepthConstant;varying float vFragmentDepth;
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=h);const I={name:c,shader:h};export{E as a,N as b,S as h,I as l,R as m,_ as p,p as s};
