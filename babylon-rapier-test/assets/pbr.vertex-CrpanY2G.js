import{k as e}from"./babylon-YuYqH10H.js";import{s as C,m as b,p as W,a as z,b as H,h as B,l as w}from"./logDepthDeclaration-5yLpa_rq.js";import{h as Y}from"./helperFunctions-CmH8YSo5.js";import{b as $,a as k,i as j,c as K,f as Q,d as Z,e as q,g as J,h as ee,j as te,v as re}from"./vertexColorMixing-Dm_9QD7g.js";const r="uvAttributeDeclaration",x=`#if defined(UV{X}) && !defined(USE_VERTEX_PULLING)
attribute uv{X}: vec2f;
#endif
`;e.IncludesShadersStoreWGSL[r]||(e.IncludesShadersStoreWGSL[r]=x);const ie={name:r,shader:x},i="prePassVertexDeclaration",T=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=T);const ne={name:i,shader:T},n="samplerVertexDeclaration",A=`#if defined(_DEFINENAME_) && _DEFINENAME_DIRECTUV==0
varying v_VARYINGNAME_UV: vec2f;
#endif
`;e.IncludesShadersStoreWGSL[n]||(e.IncludesShadersStoreWGSL[n]=A);const ae={name:n,shader:A},a="bumpVertexDeclaration",S=`#if defined(BUMP) || defined(PARALLAX) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC)
#if defined(TANGENT) && defined(NORMAL) 
varying vTBN0: vec3f;varying vTBN1: vec3f;varying vTBN2: vec3f;
#endif
#endif
`;e.IncludesShadersStoreWGSL[a]||(e.IncludesShadersStoreWGSL[a]=S);const fe={name:a,shader:S},f="lightVxUboDeclaration",V=`#ifdef LIGHT{X}
struct Light{X}
{vLightData: vec4f,
vLightDiffuse: vec4f,
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[f]||(e.IncludesShadersStoreWGSL[f]=V);const de={name:f,shader:V},d="morphTargetsVertexGlobalDeclaration",R=`#ifdef MORPHTARGETS
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[d]||(e.IncludesShadersStoreWGSL[d]=R);const oe={name:d,shader:R},o="morphTargetsVertexDeclaration",M=`#ifdef MORPHTARGETS
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[o]||(e.IncludesShadersStoreWGSL[o]=M);const se={name:o,shader:M},s="vertexPullingDeclaration",U=`#ifdef USE_VERTEX_PULLING
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[s]||(e.IncludesShadersStoreWGSL[s]=U);const le={name:s,shader:U},l="vertexPullingVertex",O=`#ifdef USE_VERTEX_PULLING
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[l]||(e.IncludesShadersStoreWGSL[l]=O);const ue={name:l,shader:O},u="morphTargetsVertexGlobal",h=`#ifdef MORPHTARGETS
#ifdef MORPHTARGETS_TEXTURE
var vertexID : f32;
#endif
#endif
`;e.IncludesShadersStoreWGSL[u]||(e.IncludesShadersStoreWGSL[u]=h);const ve={name:u,shader:h},v="morphTargetsVertex",L=`#ifdef MORPHTARGETS
#ifdef MORPHTARGETS_TEXTURE
#if {X}==0
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[v]||(e.IncludesShadersStoreWGSL[v]=L);const Ee={name:v,shader:L},E="prePassVertex",g=`#ifdef PREPASS_DEPTH
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[E]||(e.IncludesShadersStoreWGSL[E]=g);const _e={name:E,shader:g},_="uvVariableDeclaration",y=`#ifdef MAINUV{X}
#if !defined(UV{X})
...
#endif
`;e.IncludesShadersStoreWGSL[_]||(e.IncludesShadersStoreWGSL[_]=y);const pe={name:_,shader:y},p="samplerVertexImplementation",D=`#if defined(_DEFINENAME_) && _DEFINENAME_DIRECTUV==0
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[p]||(e.IncludesShadersStoreWGSL[p]=D);const ce={name:p,shader:D},c="bumpVertex",P=`#if defined(BUMP) || defined(PARALLAX) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC)
#if defined(TANGENT) && defined(NORMAL)
var tbnNormal: vec3f=normalize(normalUpdated);var tbnTangent: vec3f=normalize(tangentUpdated.xyz);var tbnBitangent: vec3f=cross(tbnNormal,tbnTangent)*tangentUpdated.w;var matTemp= mat3x3f(finalWorld[0].xyz,finalWorld[1].xyz,finalWorld[2].xyz)* mat3x3f(tbnTangent,tbnBitangent,tbnNormal);vertexOutputs.vTBN0=matTemp[0];vertexOutputs.vTBN1=matTemp[1];vertexOutputs.vTBN2=matTemp[2];
#endif
#endif
`;e.IncludesShadersStoreWGSL[c]||(e.IncludesShadersStoreWGSL[c]=P);const Ie={name:c,shader:P},I="shadowsVertex",F=`#ifdef SHADOWS
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[I]||(e.IncludesShadersStoreWGSL[I]=F);const me={name:I,shader:F},m="logDepthVertex",G=`#ifdef LOGARITHMICDEPTH
vertexOutputs.vFragmentDepth=1.0+vertexOutputs.position.w;vertexOutputs.position.z=log2(max(0.000001,vertexOutputs.vFragmentDepth))*uniforms.logarithmicDepthConstant;
#endif
`;e.IncludesShadersStoreWGSL[m]||(e.IncludesShadersStoreWGSL[m]=G);const Ne={name:m,shader:G},N="pbrVertexShader",X=`#define PBR_VERTEX_SHADER
...
}`;e.ShadersStoreWGSL[N]||(e.ShadersStoreWGSL[N]=X);const xe=[C,b,W,ie,z,Y,H,$,k,j,ne,ae,B,fe,K,Q,de,oe,se,w,le,ue,ve,Ee,Z,q,J,_e,pe,ce,Ie,ee,te,me,re,Ne];for(const t of xe)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);const Re={name:N,shader:X};export{Re as pbrVertexShaderWGSL};
