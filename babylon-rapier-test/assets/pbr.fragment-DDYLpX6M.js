import{k as e}from"./babylon-YuYqH10H.js";import{s as ui,m as Ei,p as vi,a as mi,l as hi,h as Si,b as pi}from"./logDepthDeclaration-C3hbqUbL.js";import{c as Ci,f as Ri,a as gi,b as Ii}from"./fogFragment-4iOaiVVS.js";import{h as Ai}from"./helperFunctions-_1RsL6n2.js";const t="prePassDeclaration",fe=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=fe);const Ti={name:t,shader:fe},o="oitDeclaration",le=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#extension GL_EXT_draw_buffers : require
...
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=se);const Ni={name:n,shader:se},r="pbrFragmentExtraDeclaration",de=`varying vec3 vPositionW;
#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=de);const Oi={name:r,shader:de},f="lightFragmentDeclaration",ue=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=ue);const _i={name:f,shader:ue},l="lightUboDeclaration",Ee=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
#endif
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=Ee);const Mi={name:l,shader:Ee},c="samplerFragmentDeclaration",ve=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=ve);const Fi={name:c,shader:ve},s="samplerFragmentAlternateDeclaration",me=`#ifdef _DEFINENAME_
#if _DEFINENAME_DIRECTUV==1
#define v_VARYINGNAME_UV vMainUV1
#elif _DEFINENAME_DIRECTUV==2
#define v_VARYINGNAME_UV vMainUV2
...
#endif
#endif
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=me);const Pi={name:s,shader:me},d="pbrFragmentReflectionDeclaration",he=`#ifdef REFLECTION
...
#endif
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=he);const bi={name:d,shader:he},u="pbrFragmentSamplersDeclaration",Se=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;e.IncludesShadersStore[u]||(e.IncludesShadersStore[u]=Se);const Ui={name:u,shader:Se},E="imageProcessingDeclaration",pe=`#ifdef EXPOSURE
...
#endif
`;e.IncludesShadersStore[E]||(e.IncludesShadersStore[E]=pe);const xi={name:E,shader:pe},v="textureRepetitionFunctions",Ce=`#if TEXTURE_REPETITION_MODE>0
...
`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=Ce);const yi={name:v,shader:Ce},m="subSurfaceScatteringFunctions",Re=`bool testLightingForSSS(float diffusionProfile)
{return diffusionProfile<1.;}`;e.IncludesShadersStore[m]||(e.IncludesShadersStore[m]=Re);const wi={name:m,shader:Re},h="importanceSampling",ge=`vec3 hemisphereCosSample(vec2 u) {float phi=2.*PI*u.x;float cosTheta2=1.-u.y;float cosTheta=sqrt(cosTheta2);float sinTheta=sqrt(1.-cosTheta2);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
...
float phi=2.*PI*u.x;float sinTheta=pow(u.y,a/(2.*a+1.));float cosTheta=sqrt(1.-sinTheta*sinTheta);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=ge);const Xi={name:h,shader:ge},S="pbrHelperFunctions",Ie=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;e.IncludesShadersStore[S]||(e.IncludesShadersStore[S]=Ie);const Bi={name:S,shader:Ie},p="imageProcessingFunctions",Ae=`#if defined(COLORGRADING) && !defined(COLORGRADING3D)
/** 
...
return result;}`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=Ae);const Gi={name:p,shader:Ae},C="shadowsFragmentFunctions",Te=`#ifdef SHADOWS
...
#endif
result.Diffuse=LTCEvaluateWithEmission( normal,viewDir,position,mat3( 1.0 ),rectCoords,texFilteredMap );return result;}`;e.IncludesShadersStore[R]||(e.IncludesShadersStore[R]=Le);const Vi={name:R,shader:Le},g="pbrDirectLightingSetupFunctions",De=`struct preLightingInfo
...
result.areaLightDiffuse=data.Diffuse;result.LdotV=0.;result.roughness=0.;result.diffuseRoughness=0.;result.surfaceAlbedo=vec3(0.);return result;}
#endif
`;e.IncludesShadersStore[g]||(e.IncludesShadersStore[g]=De);const Wi={name:g,shader:De},I="pbrDirectLightingFalloffFunctions",Ne=`float computeDistanceLightFalloff_Standard(vec3 lightOffset,float range)
...
#endif
}`;e.IncludesShadersStore[I]||(e.IncludesShadersStore[I]=Ne);const zi={name:I,shader:Ne},A="hdrFilteringFunctions",Oe=`#if NUM_SAMPLES
#if NUM_SAMPLES>0
#if defined(WEBGL2) || defined(WEBGPU) || defined(NATIVE)
...
#endif
#endif
`;e.IncludesShadersStore[A]||(e.IncludesShadersStore[A]=Oe);const ki={name:A,shader:Oe},T="pbrDirectLightingFunctions",_e=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{vec3 diffuse;
...
#endif
`;e.IncludesShadersStore[T]||(e.IncludesShadersStore[T]=_e);const Yi={name:T,shader:_e},L="pbrIBLFunctions",Me=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;e.IncludesShadersStore[L]||(e.IncludesShadersStore[L]=Me);const $i={name:L,shader:Me},D="bumpFragmentMainFunctions",Fe=`#ifndef TEXRD_DEFINED
#define TEXRD(s,uv) texture2D(s,uv)
#define TEXRD_DEFINED
#endif
...
#endif
`;e.IncludesShadersStore[D]||(e.IncludesShadersStore[D]=Fe);const Ki={name:D,shader:Fe},N="bumpFragmentFunctions",Pe=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStore[N]||(e.IncludesShadersStore[N]=Pe);const qi={name:N,shader:Pe},O="reflectionFunction",be=`vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
#endif
`;e.IncludesShadersStore[O]||(e.IncludesShadersStore[O]=be);const Zi={name:O,shader:be},_="decalFragment",Ue=`#ifdef DECAL
#ifdef GAMMADECAL
...
#endif
`;e.IncludesShadersStore[_]||(e.IncludesShadersStore[_]=Ue);const ji={name:_,shader:Ue},M="pbrBlockAlbedoOpacity",xe=`struct albedoOpacityOutParams
...
`;e.IncludesShadersStore[M]||(e.IncludesShadersStore[M]=xe);const Qi={name:M,shader:xe},F="pbrBlockReflectivity",ye=`struct reflectivityOutParams
...
`;e.IncludesShadersStore[F]||(e.IncludesShadersStore[F]=ye);const Ji={name:F,shader:ye},P="pbrBlockAmbientOcclusion",we=`struct ambientOcclusionOutParams
{vec3 ambientOcclusionColor;
...
`;e.IncludesShadersStore[P]||(e.IncludesShadersStore[P]=we);const et={name:P,shader:we},b="pbrBlockAlphaFresnel",Xe=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;e.IncludesShadersStore[b]||(e.IncludesShadersStore[b]=Xe);const it={name:b,shader:Xe},U="pbrBlockAnisotropic",Be=`#ifdef ANISOTROPIC
...
#endif
`;e.IncludesShadersStore[U]||(e.IncludesShadersStore[U]=Be);const tt={name:U,shader:Be},x="pbrBlockReflection",Ge=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStore[x]||(e.IncludesShadersStore[x]=Ge);const ot={name:x,shader:Ge},y="pbrBlockSheen",He=`#ifdef SHEEN
...
#endif
`;e.IncludesShadersStore[y]||(e.IncludesShadersStore[y]=He);const at={name:y,shader:He},w="pbrBlockClearcoat",Ve=`struct clearcoatOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[w]||(e.IncludesShadersStore[w]=Ve);const nt={name:w,shader:Ve},X="pbrBlockIridescence",We=`struct iridescenceOutParams
...
#endif
`;e.IncludesShadersStore[X]||(e.IncludesShadersStore[X]=We);const rt={name:X,shader:We},B="pbrBlockSubSurface",ze=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[B]||(e.IncludesShadersStore[B]=ze);const ft={name:B,shader:ze},G="clusteredLightingFunctions",ke=`struct ClusteredLight {vec4 vLightData;vec4 vLightDiffuse;vec4 vLightSpecular;vec4 vLightDirection;vec4 vLightFalloff;};
#define inline
...
`;e.IncludesShadersStore[G]||(e.IncludesShadersStore[G]=ke);const lt={name:G,shader:ke},H="pbrBlockReflectance0",Ye=`float reflectanceF0=reflectivityOut.reflectanceF0;vec3 specularEnvironmentR0=reflectivityOut.colorReflectanceF0;vec3 specularEnvironmentR90=reflectivityOut.colorReflectanceF90;
#ifdef ALPHAFRESNEL
float reflectance90=fresnelGrazingReflectance(reflectanceF0);specularEnvironmentR90=specularEnvironmentR90*reflectance90;
#endif
`;e.IncludesShadersStore[H]||(e.IncludesShadersStore[H]=Ye);const ct={name:H,shader:Ye},V="pbrClusteredLightingFunctions",$e=`#if defined(CLUSTLIGHT_BATCH) && CLUSTLIGHT_BATCH>0
...
return result;}
#endif
`;e.IncludesShadersStore[V]||(e.IncludesShadersStore[V]=$e);const st={name:V,shader:$e},W="pbrBlockNormalGeometric",Ke=`vec3 viewDirectionW=normalize(vEyePosition.xyz-vPositionW);
#ifdef NORMAL
...
#endif
`;e.IncludesShadersStore[W]||(e.IncludesShadersStore[W]=Ke);const dt={name:W,shader:Ke},z="bumpFragment",qe=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;e.IncludesShadersStore[z]||(e.IncludesShadersStore[z]=qe);const ut={name:z,shader:qe},k="pbrBlockNormalFinal",Ze=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStore[k]||(e.IncludesShadersStore[k]=Ze);const Et={name:k,shader:Ze},Y="depthPrePass",je=`#ifdef DEPTHPREPASS
gl_FragColor=vec4(0.,0.,0.,1.0);return;
#endif
`;e.IncludesShadersStore[Y]||(e.IncludesShadersStore[Y]=je);const vt={name:Y,shader:je},$="pbrBlockLightmapInit",Qe=`#ifdef LIGHTMAP
...
#endif
`;e.IncludesShadersStore[$]||(e.IncludesShadersStore[$]=Qe);const mt={name:$,shader:Qe},K="pbrBlockGeometryInfo",Je=`float NdotVUnclamped=dot(normalW,viewDirectionW);float NdotV=absEps(NdotVUnclamped);float alphaG=convertRoughnessToAverageSlope(roughness);vec2 AARoughnessFactors=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;e.IncludesShadersStore[K]||(e.IncludesShadersStore[K]=Je);const ht={name:K,shader:Je},q="pbrBlockReflectance",ei=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;e.IncludesShadersStore[q]||(e.IncludesShadersStore[q]=ei);const St={name:q,shader:ei},Z="pbrBlockDirectLighting",ii=`vec3 diffuseBase=vec3(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;e.IncludesShadersStore[Z]||(e.IncludesShadersStore[Z]=ii);const pt={name:Z,shader:ii},j="lightFragment",ti=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[j]||(e.IncludesShadersStore[j]=ti);const Ct={name:j,shader:ti},Q="pbrBlockFinalLitComponents",oi=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;e.IncludesShadersStore[Q]||(e.IncludesShadersStore[Q]=oi);const Rt={name:Q,shader:oi},J="pbrBlockFinalUnlitComponents",ai=`vec3 finalDiffuse=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;e.IncludesShadersStore[J]||(e.IncludesShadersStore[J]=ai);const gt={name:J,shader:ai},ee="pbrBlockFinalColorComposition",ni=`vec4 finalColor=vec4(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;e.IncludesShadersStore[ee]||(e.IncludesShadersStore[ee]=ni);const It={name:ee,shader:ni},ie="logDepthFragment",ri=`#ifdef LOGARITHMICDEPTH
gl_FragDepthEXT=log2(vFragmentDepth)*logarithmicDepthConstant*0.5;
#endif
`;e.IncludesShadersStore[ie]||(e.IncludesShadersStore[ie]=ri);const At={name:ie,shader:ri},te="pbrBlockImageProcessing",fi=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;e.IncludesShadersStore[te]||(e.IncludesShadersStore[te]=fi);const Tt={name:te,shader:fi},oe="pbrBlockPrePass",li=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;e.IncludesShadersStore[oe]||(e.IncludesShadersStore[oe]=li);const Lt={name:oe,shader:li},ae="oitFragment",ci=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;e.IncludesShadersStore[ae]||(e.IncludesShadersStore[ae]=ci);const Dt={name:ae,shader:ci},ne="pbrDebug",si=`#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStore[ne]||(e.IncludesShadersStore[ne]=si);const Nt={name:ne,shader:si},re="pbrPixelShader",di=`#define PBR_FRAGMENT_SHADER
...
`;e.ShadersStore[re]||(e.ShadersStore[re]=di);const Ot=[Ti,Li,Di,Ni,ui,Ei,vi,mi,Oi,_i,Mi,Fi,Pi,bi,Ui,xi,Ci,hi,Ri,yi,Ai,wi,Xi,Bi,Gi,Hi,Si,Vi,Wi,zi,pi,ki,Yi,$i,Ki,qi,Zi,ji,Qi,Ji,et,it,tt,ot,at,nt,rt,ft,lt,ct,st,gi,dt,ut,Et,vt,mt,ht,St,pt,Ct,Rt,gt,It,At,Ii,Tt,Lt,Dt,Nt];for(const i of Ot)e.IncludesShadersStore[i.name]||(e.IncludesShadersStore[i.name]=i.shader);const bt={name:re,shader:di};export{bt as pbrPixelShader};
