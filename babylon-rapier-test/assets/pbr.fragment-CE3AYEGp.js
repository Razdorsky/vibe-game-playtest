import{k as e}from"./babylon-YuYqH10H.js";import{s as tr,m as fr,p as nr,a as or,l as cr,h as lr,b as sr}from"./logDepthDeclaration-5yLpa_rq.js";import{c as dr,f as vr,a as ur,b as mr}from"./fogFragment-B3ivi2R2.js";import{h as pr}from"./helperFunctions-CmH8YSo5.js";const a="prePassDeclaration",ie=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[a]||(e.IncludesShadersStoreWGSL[a]=ie);const Sr={name:a,shader:ie},i="oitDeclaration",te=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#define MAX_DEPTH 99999.0
var oitDepthSamplerSampler: sampler;var oitDepthSampler: texture_2d<f32>;var oitFrontColorSamplerSampler: sampler;var oitFrontColorSampler: texture_2d<f32>;
#endif
`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=te);const hr={name:i,shader:te},t="pbrFragmentExtraDeclaration",fe=`varying vPositionW: vec3f;
#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=fe);const Er={name:t,shader:fe},f="lightUboDeclaration",ne=`#ifdef LIGHT{X}
struct Light{X}
{vLightData: vec4f,
vLightDiffuse: vec4f,
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[f]||(e.IncludesShadersStoreWGSL[f]=ne);const Rr={name:f,shader:ne},n="samplerFragmentDeclaration",oe=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStoreWGSL[n]||(e.IncludesShadersStoreWGSL[n]=oe);const Cr={name:n,shader:oe},o="samplerFragmentAlternateDeclaration",ce=`#ifdef _DEFINENAME_
#if _DEFINENAME_DIRECTUV==1
#define v_VARYINGNAME_UV vMainUV1
#elif _DEFINENAME_DIRECTUV==2
#define v_VARYINGNAME_UV vMainUV2
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[o]||(e.IncludesShadersStoreWGSL[o]=ce);const gr={name:o,shader:ce},c="pbrFragmentReflectionDeclaration",le=`#ifdef REFLECTION
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[c]||(e.IncludesShadersStoreWGSL[c]=le);const Ir={name:c,shader:le},l="pbrFragmentSamplersDeclaration",se=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;e.IncludesShadersStoreWGSL[l]||(e.IncludesShadersStoreWGSL[l]=se);const Lr={name:l,shader:se},s="imageProcessingDeclaration",de=`#ifdef EXPOSURE
...
#endif
`;e.IncludesShadersStoreWGSL[s]||(e.IncludesShadersStoreWGSL[s]=de);const Tr={name:s,shader:de},d="textureRepetitionFunctions",ve=`#if TEXTURE_REPETITION_MODE>0
...
`;e.IncludesShadersStoreWGSL[d]||(e.IncludesShadersStoreWGSL[d]=ve);const Ar={name:d,shader:ve},v="subSurfaceScatteringFunctions",ue=`fn testLightingForSSS(diffusionProfile: f32)->bool
{return diffusionProfile<1.;}`;e.IncludesShadersStoreWGSL[v]||(e.IncludesShadersStoreWGSL[v]=ue);const Nr={name:v,shader:ue},u="importanceSampling",me=`fn hemisphereCosSample(u: vec2f)->vec3f {var phi: f32=2.*PI*u.x;var cosTheta2: f32=1.-u.y;var cosTheta: f32=sqrt(cosTheta2);var sinTheta: f32=sqrt(1.-cosTheta2);return vec3f(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
...
var phi: f32=2.*PI*u.x;var sinTheta: f32=pow(u.y,a/(2.*a+1.));var cosTheta: f32=sqrt(1.-sinTheta*sinTheta);return vec3f(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}`;e.IncludesShadersStoreWGSL[u]||(e.IncludesShadersStoreWGSL[u]=me);const Or={name:u,shader:me},m="pbrHelperFunctions",pe=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;e.IncludesShadersStoreWGSL[m]||(e.IncludesShadersStoreWGSL[m]=pe);const Dr={name:m,shader:pe},p="imageProcessingFunctions",Se=`#if TONEMAPPING==3
...
return vec4f(rgb,result.a);}`;e.IncludesShadersStoreWGSL[p]||(e.IncludesShadersStoreWGSL[p]=Se);const _r={name:p,shader:Se},S="shadowsFragmentFunctions",he=`#ifdef SHADOWS
#ifndef SHADOWFLOAT
...
#endif
`;e.IncludesShadersStoreWGSL[S]||(e.IncludesShadersStoreWGSL[S]=he);const xr={name:S,shader:he},h="ltcHelperFunctions",Ee=`fn LTCUv(N: vec3f,V: vec3f,roughness: f32)->vec2f {var LUTSIZE: f32=64.0;var LUTSCALE: f32=( LUTSIZE-1.0 )/LUTSIZE;var LUTBIAS:f32=0.5/LUTSIZE;var dotNV:f32=saturate( dot( N,V ) );var uv:vec2f=vec2f( roughness,sqrt( 1.0-dotNV ) );uv=uv*LUTSCALE+LUTBIAS;return uv;}
...
`;e.IncludesShadersStoreWGSL[h]||(e.IncludesShadersStoreWGSL[h]=Ee);const Mr={name:h,shader:Ee},E="pbrDirectLightingSetupFunctions",Re=`struct preLightingInfo
{lightOffset: vec3f,
...
#endif
`;e.IncludesShadersStoreWGSL[E]||(e.IncludesShadersStoreWGSL[E]=Re);const Fr={name:E,shader:Re},R="pbrDirectLightingFalloffFunctions",Ce=`fn computeDistanceLightFalloff_Standard(lightOffset: vec3f,range: f32)->f32
...
#endif
}`;e.IncludesShadersStoreWGSL[R]||(e.IncludesShadersStoreWGSL[R]=Ce);const Pr={name:R,shader:Ce},C="hdrFilteringFunctions",ge=`#ifdef NUM_SAMPLES
#if NUM_SAMPLES>0
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[C]||(e.IncludesShadersStoreWGSL[C]=ge);const wr={name:C,shader:ge},g="clusteredLightingFunctions",Ie=`struct ClusteredLight {vLightData: vec4f,
vLightDiffuse: vec4f,
vLightSpecular: vec4f,
vLightDirection: vec4f,
vLightFalloff: vec4f,}
...
`;e.IncludesShadersStoreWGSL[g]||(e.IncludesShadersStoreWGSL[g]=Ie);const yr={name:g,shader:Ie},I="pbrBlockReflectance0",Le=`var reflectanceF0: f32=reflectivityOut.reflectanceF0;var specularEnvironmentR0: vec3f=reflectivityOut.colorReflectanceF0;var specularEnvironmentR90: vec3f= reflectivityOut.reflectanceF90;
#ifdef ALPHAFRESNEL
...
#endif
`;e.IncludesShadersStoreWGSL[I]||(e.IncludesShadersStoreWGSL[I]=Le);const br={name:I,shader:Le},L="pbrDirectLightingFunctions",Te=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{diffuse: vec3f,
...
return result;}
#endif
`;e.IncludesShadersStoreWGSL[L]||(e.IncludesShadersStoreWGSL[L]=Te);const Ur={name:L,shader:Te},T="pbrIBLFunctions",Ae=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;e.IncludesShadersStoreWGSL[T]||(e.IncludesShadersStoreWGSL[T]=Ae);const Gr={name:T,shader:Ae},A="bumpFragmentMainFunctions",Ne=`#ifndef TEXRD_DEFINED
fn TEXRD(t: texture_2d<f32>,ts: sampler,uv: vec2f)->vec4f {return textureSample(t,ts,uv);}
#define TEXRD_DEFINED
#endif
...
#endif
`;e.IncludesShadersStoreWGSL[A]||(e.IncludesShadersStoreWGSL[A]=Ne);const Xr={name:A,shader:Ne},N="bumpFragmentFunctions",Oe=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStoreWGSL[N]||(e.IncludesShadersStoreWGSL[N]=Oe);const Br={name:N,shader:Oe},O="reflectionFunction",De=`fn computeFixedEquirectangularCoords(worldPos: vec4f,worldNormal: vec3f,direction: vec3f)->vec3f
...
#endif
`;e.IncludesShadersStoreWGSL[O]||(e.IncludesShadersStoreWGSL[O]=De);const Vr={name:O,shader:De},D="decalFragment",_e=`#ifdef DECAL
...
#endif
`;e.IncludesShadersStoreWGSL[D]||(e.IncludesShadersStoreWGSL[D]=_e);const Hr={name:D,shader:_e},_="pbrBlockAlbedoOpacity",xe=`struct albedoOpacityOutParams
{surfaceAlbedo: vec3f,
alpha: f32};
#define pbr_inline
...
`;e.IncludesShadersStoreWGSL[_]||(e.IncludesShadersStoreWGSL[_]=xe);const Wr={name:_,shader:xe},x="pbrBlockReflectivity",Me=`struct reflectivityOutParams
{microSurface: f32,
roughness: f32,
diffuseRoughness: f32,
reflectanceF0: f32,
...
`;e.IncludesShadersStoreWGSL[x]||(e.IncludesShadersStoreWGSL[x]=Me);const zr={name:x,shader:Me},M="pbrBlockAmbientOcclusion",Fe=`struct ambientOcclusionOutParams
{ambientOcclusionColor: vec3f,
...
`;e.IncludesShadersStoreWGSL[M]||(e.IncludesShadersStoreWGSL[M]=Fe);const kr={name:M,shader:Fe},F="pbrBlockAlphaFresnel",Pe=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[F]||(e.IncludesShadersStoreWGSL[F]=Pe);const Yr={name:F,shader:Pe},P="pbrBlockAnisotropic",we=`#ifdef ANISOTROPIC
...
#endif
`;e.IncludesShadersStoreWGSL[P]||(e.IncludesShadersStoreWGSL[P]=we);const $r={name:P,shader:we},w="pbrBlockReflection",ye=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStoreWGSL[w]||(e.IncludesShadersStoreWGSL[w]=ye);const Kr={name:w,shader:ye},y="pbrBlockSheen",be=`#ifdef SHEEN
...
#endif
`;e.IncludesShadersStoreWGSL[y]||(e.IncludesShadersStoreWGSL[y]=be);const qr={name:y,shader:be},b="pbrBlockClearcoat",Ue=`struct clearcoatOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStoreWGSL[b]||(e.IncludesShadersStoreWGSL[b]=Ue);const Zr={name:b,shader:Ue},U="pbrBlockIridescence",Ge=`struct iridescenceOutParams
{iridescenceIntensity: f32,
iridescenceIOR: f32,
...
#endif
`;e.IncludesShadersStoreWGSL[U]||(e.IncludesShadersStoreWGSL[U]=Ge);const jr={name:U,shader:Ge},G="pbrBlockSubSurface",Xe=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStoreWGSL[G]||(e.IncludesShadersStoreWGSL[G]=Xe);const Qr={name:G,shader:Xe},X="pbrBlockNormalGeometric",Be=`var viewDirectionW: vec3f=normalize(scene.vEyePosition.xyz-input.vPositionW);
#ifdef NORMAL
...
#endif
`;e.IncludesShadersStoreWGSL[X]||(e.IncludesShadersStoreWGSL[X]=Be);const Jr={name:X,shader:Be},B="bumpFragment",Ve=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;e.IncludesShadersStoreWGSL[B]||(e.IncludesShadersStoreWGSL[B]=Ve);const ea={name:B,shader:Ve},V="pbrBlockNormalFinal",He=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[V]||(e.IncludesShadersStoreWGSL[V]=He);const ra={name:V,shader:He},H="depthPrePass",We=`#ifdef DEPTHPREPASS
#if !defined(PREPASS) && !defined(ORDER_INDEPENDENT_TRANSPARENCY)
fragmentOutputs.color= vec4f(0.,0.,0.,1.0);
#endif
return fragmentOutputs;
#endif
`;e.IncludesShadersStoreWGSL[H]||(e.IncludesShadersStoreWGSL[H]=We);const aa={name:H,shader:We},W="pbrBlockLightmapInit",ze=`#ifdef LIGHTMAP
...
#endif
`;e.IncludesShadersStoreWGSL[W]||(e.IncludesShadersStoreWGSL[W]=ze);const ia={name:W,shader:ze},z="pbrBlockGeometryInfo",ke=`var NdotVUnclamped: f32=dot(normalW,viewDirectionW);var NdotV: f32=absEps(NdotVUnclamped);var alphaG: f32=convertRoughnessToAverageSlope(roughness);var AARoughnessFactors: vec2f=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[z]||(e.IncludesShadersStoreWGSL[z]=ke);const ta={name:z,shader:ke},k="pbrBlockReflectance",Ye=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[k]||(e.IncludesShadersStoreWGSL[k]=Ye);const fa={name:k,shader:Ye},Y="pbrBlockDirectLighting",$e=`var diffuseBase: vec3f=vec3f(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;e.IncludesShadersStoreWGSL[Y]||(e.IncludesShadersStoreWGSL[Y]=$e);const na={name:Y,shader:$e},$="lightFragment",Ke=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[$]||(e.IncludesShadersStoreWGSL[$]=Ke);const oa={name:$,shader:Ke},K="pbrBlockFinalLitComponents",qe=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[K]||(e.IncludesShadersStoreWGSL[K]=qe);const ca={name:K,shader:qe},q="pbrBlockFinalUnlitComponents",Ze=`var finalDiffuse: vec3f=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;e.IncludesShadersStoreWGSL[q]||(e.IncludesShadersStoreWGSL[q]=Ze);const la={name:q,shader:Ze},Z="pbrBlockFinalColorComposition",je=`var finalColor: vec4f= vec4f(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;e.IncludesShadersStoreWGSL[Z]||(e.IncludesShadersStoreWGSL[Z]=je);const sa={name:Z,shader:je},j="logDepthFragment",Qe=`#ifdef LOGARITHMICDEPTH
fragmentOutputs.fragDepth=log2(fragmentInputs.vFragmentDepth)*uniforms.logarithmicDepthConstant*0.5;
#endif
`;e.IncludesShadersStoreWGSL[j]||(e.IncludesShadersStoreWGSL[j]=Qe);const da={name:j,shader:Qe},Q="pbrBlockImageProcessing",Je=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;e.IncludesShadersStoreWGSL[Q]||(e.IncludesShadersStoreWGSL[Q]=Je);const va={name:Q,shader:Je},J="pbrBlockPrePass",er=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[J]||(e.IncludesShadersStoreWGSL[J]=er);const ua={name:J,shader:er},ee="oitFragment",rr=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;e.IncludesShadersStoreWGSL[ee]||(e.IncludesShadersStoreWGSL[ee]=rr);const ma={name:ee,shader:rr},re="pbrDebug",ar=`#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStoreWGSL[re]||(e.IncludesShadersStoreWGSL[re]=ar);const pa={name:re,shader:ar},ae="pbrPixelShader",ir=`#define PBR_FRAGMENT_SHADER
...
`;e.ShadersStoreWGSL[ae]||(e.ShadersStoreWGSL[ae]=ir);const Sa=[Sr,hr,tr,fr,nr,or,Er,Rr,Cr,gr,Ir,Lr,Tr,dr,cr,vr,Ar,pr,Nr,Or,Dr,_r,xr,lr,Mr,Fr,Pr,sr,wr,yr,br,Ur,Gr,Xr,Br,Vr,Hr,Wr,zr,kr,Yr,$r,Kr,qr,Zr,jr,Qr,ur,Jr,ea,ra,aa,ia,ta,fa,na,oa,ca,la,sa,da,mr,va,ua,ma,pa];for(const r of Sa)e.IncludesShadersStoreWGSL[r.name]||(e.IncludesShadersStoreWGSL[r.name]=r.shader);const ga={name:ae,shader:ir};export{ga as pbrPixelShaderWGSL};
